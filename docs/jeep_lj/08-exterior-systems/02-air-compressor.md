...
Compressor has internal relay/control that handles high-current motor switching; SwitchPros OUTPUT-11 only supplies the switched 12V control signal. See Wiring table below for circuit detail.
