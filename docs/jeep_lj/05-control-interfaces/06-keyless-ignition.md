...
Normal shutdown here (brake + 2 sec hold) only cuts ECM power via PINK IGN — it cannot stop a runaway sustained by oil or hydrocarbon vapor. See [Diesel Runaway Protection][runaway-protection] for the mechanical prevention/termination layers.
