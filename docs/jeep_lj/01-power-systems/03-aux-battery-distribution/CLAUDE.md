...
Note: AUX battery itself has NO local CONSTANT bus. Battery has 5 stacked terminal lugs + 3 inline CBs (250A master forward feed + 150A SafetyHub local + 80A audio amp).
