...
The original HDP24-24-21 (17 size-16 + 4 size-12) was at 16 of 17 size-16 capacity. SwitchPros relocation to the firewall, the Firewall CONSTANT bus, and keyless ignition then added 5 more circuits — filling the last size-16 spare and all 4 size-12 reserved cavities, with zero headroom left for anything after. That capacity crunch is what drove the upsize to HDP24-24-29 and the split-out SwitchPros HDP24-18-14 bulkhead (see the info box above).
