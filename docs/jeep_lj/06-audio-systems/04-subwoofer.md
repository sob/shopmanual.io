...
Each sub runs on its own dedicated bridged channel pair (Sub A: Ch 1+2, Sub B: Ch 3+4, both @ 4Ω) — rationale for the per-sub bridged-pair choice is in [Amplifier → Channel Configuration][amplifier].
