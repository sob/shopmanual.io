...
| Area | State |
| :--- | :---- |
| **Starlink power** | Resolved - [Starlink Advanced Power Supply](01-power-systems/01-starlink-power.md) replaces the 1000 W inverter ([#4][issue-4]) |
...
| **Network** | UniFi UXG Lite gateway, USW-Flex-Mini switch |
